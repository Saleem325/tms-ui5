		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test deploy CL",
									"targetURL": "#sapbtpztestui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpztestui5-display": {
								"semanticObject": "sapbtpztestui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ztestui5",
									"url": sap.ui.require.toUrl("sap/btp/ztestui5")
								}
							}
						}
					}
